...
const alarmAudio = "https://actions.google.com/sounds/v1/cartoon/wood_plank_flicks.ogg";

const eggTypes = [
  { name: 'เนื้อวัว (ชิ้นหนา ~2.5 ซม.)', time: 240, description: '4 นาทีต่อด้าน อุณหภูมิ 65°C' },
  { name: 'เนื้อหมู (ชิ้นหนา ~2.5 ซม.)', time: 360, description: '6 นาทีต่อด้าน อุณหภูมิ 70°C' },
  { name: 'เนื้อไก่ (อก/น่อง/ชิ้นหนา ~3 ซม.)', time: 600, description: '10 นาที อุณหภูมิ 75°C' },
  { name: 'ไส้กรอก / เบคอน', time: 300, description: '5 นาทีจนร้อนทั่ว อุณหภูมิ 75°C' },
];
